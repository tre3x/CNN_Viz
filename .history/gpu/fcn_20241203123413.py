...
if __name__=="__main__":
    ...
    weights = np.random.rand(3, 3, 3, 16).astype(np.float32)
    ...
    output_cuda = fully_connected_layer(d_input, d_kernel, d_bias)
    convolution.check(output_cuda, input_tensor, kernel, bias)
